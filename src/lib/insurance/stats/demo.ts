...
/**
 * 보험 키워드 검색 수요 트렌드 근사치 (상대지수 0~100) —
 * 펫보험 상승 추세, 여행자보험 휴가철 계절성 등 실제 패턴 형태 참고용.
 */
export const DEMO_SEARCH_TRENDS: SearchTrendData = {
  months: [
  ...
  series: [
    {
      name: "펫보험",
      values: [42, 44, 45, 47, 48, 50, 53, 55, 58, 60, 62, 65, 67, 70, 72, 75, 78, 82, 85, 88, 91, 94, 97, 100],
    },
    {
      name: "여행자보험",
      values: [78, 60, 48, 42, 45, 55, 50, 45, 48, 55, 68, 85, 80, 62, 50, 46, 52, 60, 54, 49, 52, 60, 73, 88],
    },
    {
      name: "암보험",
      values: [52, 51, 50, 49, 50, 51, 52, 53, 52, 51, 50, 49, 50, 51, 52, 53, 52, 51, 50, 49, 50, 51, 52, 53],
    },
    {
      name: "치아보험",
      values: [38, 37, 36, 36, 35, 35, 36, 37, 38, 37, 36, 35, 35, 36, 37, 38, 37, 36, 35, 34, 35, 36, 37, 38],
    },
    {
      name: "운전자보험",
      values: [33, 34, 35, 34, 33, 32, 33, 35, 36, 35, 34, 33, 34, 35, 36, 35, 34, 33, 34, 36, 37, 36, 35, 34],
    },
  ],
};
